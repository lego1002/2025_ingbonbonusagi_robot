...
class MotorCController(Node):
    ...
    def __init__(self) -> None:
        ...
        self.get_logger().info(
            f'[MotorCController] connect action: {self.get_namespace()}/{self.action_name}, '
