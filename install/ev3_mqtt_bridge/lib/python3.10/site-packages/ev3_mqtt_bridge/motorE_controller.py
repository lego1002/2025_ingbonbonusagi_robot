...
class MotorEController(Node):
    """
    MotorE Controller (Action 版)
    ...
    def __init__(self) -> None:
        super().__init__('motorE_controller')
        ...
        self.get_logger().info(
            f'[MotorEController] connect action: {self.get_namespace()}/{self.action_name}, '
